...
export default function GroupedExpenseForm({
  onSubmit,
}: GroupedExpenseFormProps) {
  const { groups, expenses, addExpense, updateExpense, deleteExpense } =
    useFinancialData();
  ...
  const handleUpdateExpenseColor = (id: string, color: string) => {
    updateExpense(id, { color });
  };
  ...
  const handleAddCycle = (expenseId: string) => {
    ...
    updateExpense(expenseId, { cycles: [...expense.cycles, newCycle] });
  };
  ...
  const handleUpdateCycle = (
    ...
    updateExpense(expenseId, { cycles: updatedCycles });
  };
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={expense.name}
                        onChange={(e) =>
                          handleUpdateExpenseName(expense.id, e.target.value)
                        }
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-2">
                        <input
                          ...
                          value={expense.color}
                          onChange={(e) =>
                            handleUpdateExpenseColor(expense.id, e.target.value)
                          }
