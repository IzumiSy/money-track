...
interface GroupedIncomeFormProps {
  onSubmit?: () => void;
}

export default function GroupedIncomeForm({
  onSubmit,
}: GroupedIncomeFormProps) {
  const { groups, incomes, addIncome, updateIncome, deleteIncome } =
    useFinancialData();
  ...
  const handleUpdateIncomeName = (id: string, name: string) => {
    updateIncome(id, { name });
  };

  const handleUpdateIncomeColor = (id: string, color: string) => {
    updateIncome(id, { color });
  };
  ...
  const handleAddCycle = (incomeId: string) => {
    ...
    updateIncome(incomeId, { cycles: [...income.cycles, newCycle] });
  };
  ...
  const handleUpdateCycle = (
    ...
    updateIncome(incomeId, { cycles: updatedCycles });
  };
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={income.name}
                        onChange={(e) =>
                          handleUpdateIncomeName(income.id, e.target.value)
                        }
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-2">
                        <input
                          ...
                          value={income.color}
                          onChange={(e) =>
                            handleUpdateIncomeColor(income.id, e.target.value)
                          }
