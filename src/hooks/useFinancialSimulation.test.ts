      ...
      [
        {
          ...
          color: "#10B981",
          startYearMonth: YearMonthDuration.from(currentYear, 1), // 現在年の1月から開始
          endYearMonth: YearMonthDuration.from(currentYear + 1, 6), // 翌年の6月で終了
        },
      ],
      [],
      3
      ...
      [
        {
          ...
          color: "#10B981",
          startYearMonth: YearMonthDuration.from(currentYear, 1), // 現在年の1月から開始
          endYearMonth: YearMonthDuration.from(currentYear, 6), // 現在年の6月で終了
        },
      ],
      [],
      3
      ...
      [
        {
          ...
          endYearMonth: YearMonthDuration.from(currentYear + 1, 12), // 翌年末まで
        },
      ],
      [
        {
          ...
          monthlyAmount: 20000, // 月2万円
          color: "#EF4444",
          startYearMonth: YearMonthDuration.from(currentYear, 7), // 現在年の7月から
          endYearMonth: YearMonthDuration.from(currentYear + 2, 6), // 翌々年の6月まで
        },
      ],
      3
    );
